...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: '폴더', 
                description: '구글 드라이브에서 관리되는 폴더', 
                key: 'folders', 
                route: '/folderManagements/folders',
                ImageUrl: '',
            },
            { 
                title: '검색', 
                description: '구글 드라이브에서의 파일 검색', 
                key: 'searches', 
                route: '/searchEngines/searches',
                ImageUrl: '',
            },
